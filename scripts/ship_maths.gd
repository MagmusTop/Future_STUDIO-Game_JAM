...
var questions = [
	{
		...
		"answers": ["923", "905", "912"],
		"correct_answer": 0,
		"hint": "Commencez par additionner les unités, puis les dizaines, puis les centaines. Cela peut vous aider à éviter les erreurs."
	},
	{
		"question": "Quel est le périmètre d'un rectangle dont la longueur est 8 cm et la largeur 5 cm ?",
		"answers": ["26 cm", "32 cm", "40 cm"],
		"correct_answer": 0,
		"hint": "Rappelez-vous que le périmètre d'un rectangle se calcule avec la formule : P=2×(longueur+largeur). Multipliez la somme des deux dimensions par 2. Assurez-vous de bien additionner les deux dimensions avant de multiplier."
	},
	{
		"question": "Quel est le résultat de 3/4+5/8?",
		"answers": ["11/8", "7/8", "1/2"],
		"correct_answer": 0,
		"hint": "Pour additionner des fractions, il faut qu'elles aient le même dénominateur. Si les dénominateurs sont différents, commencez par les mettre au même dénominateur avant d'additionner les numérateurs. Ici, vous devez multiplier 3/4 par 2/2 pour que les deux fractions aient le même dénominateur, puis additionner."
	},
	{
		"question": "Si 5 pommes coûtent 3 € et que vous voulez acheter 15 pommes, combien cela va-t-il coûter ?",
		"answers": ["7,50 €", "9 €", "12 €"],
		"correct_answer": 1,
		"hint": "Utilisez la règle de trois pour résoudre cette question. Si 5 pommes coûtent 3 €, alors le coût d'une pomme est 3/5. Multipliez ce prix par 15 pour trouver le coût total des 15 pommes."
	},
	{
		"question": "Quel est le résultat de 2³ ?",
		"answers": ["6", "8", "9"],
		"correct_answer": 1,
		"hint": "Rappelez-vous que 2³ signifie multiplier 2 par lui-même trois fois : 2×2×2=8. Assurez-vous de bien comprendre ce que signifie l'exposant."
	}
]
