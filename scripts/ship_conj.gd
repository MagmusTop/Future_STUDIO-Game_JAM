...
@onready var pause_title = get_parent().get_node("PauseMenu/TitleLabel")
@onready var pause_continue_button = get_parent().get_node("PauseMenu/ContinueButton")
@onready var pause_quit_button = get_parent().get_node("PauseMenu/QuitButton")
