...
var questions = [
	{
		"question": "Selon la première loi de Newton, qu'est-ce qui détermine le mouvement d'un objet ?",
		"answers": ["La force qui agit sur l'objet", "La vitesse initiale de l'objet", "L'inertie de l'objet"],
		"correct_answer": 2,
		"hint": "La première loi de Newton, aussi appelée la loi de l'inertie, stipule qu'un objet en mouvement ou au repos reste dans cet état à moins qu'une force extérieure n'agisse sur lui. Il est important de comprendre que le mouvement est lié à l'inertie de l'objet, qui est sa tendance à résister aux changements dans son état de mouvement."
	},
	{
		"question": "Quelle est la formule de l'énergie cinétique (Ec​) d'un objet en mouvement ?",
		"answers": ["Ec = m * v", "Ec = ½ * m * v²", "Ec = m * g * h"],
		"correct_answer": 1,
		"hint": "L'énergie cinétique dépend de la masse (m) de l'objet et de la vitesse (v) à laquelle il se déplace. Ne confondez pas avec la formule de l'énergie potentielle gravitationnelle, qui est Ep=m×g×h, où g est l'accélération due à la gravité et h la hauteur."
	},
	{
		"question": "La loi de conservation de l'énergie stipule que l'énergie totale dans un système fermé reste :",
		"answers": ["Constante, elle peut seulement se transformer d'une forme à une autre", "Augmenter avec le temps", "Diminuer au fur et à mesure des transformations"],
		"correct_answer": 0,
		"hint": "La loi de conservation de l'énergie est un principe fondamental de la physique qui indique que l'énergie ne peut ni être créée ni détruite, seulement convertie d'une forme à une autre (comme de l'énergie cinétique en énergie thermique). Rappelez-vous qu'en tout système fermé, l'énergie totale ne varie pas, elle reste constante."
	},
	{
		"question": "Dans un circuit en série, si la résistance totale est de 12 ohms et qu'une tension de 24 V est appliquée, quelle est l'intensité du courant ?",
		"answers": ["2 A", "12 A", "24 A"],
		"correct_answer": 0,
		"hint": "Utilisez la loi d'Ohm pour résoudre ce problème : I=V/R, où I est l'intensité, V est la tension et R est la résistance. Ici, I=24/12=2 A. Si vous obtenez une autre réponse, vérifiez vos calculs et assurez-vous d'avoir bien utilisé la bonne formule."
	},
	{
		"question": "Lorsqu'un gaz est comprimé rapidement, quelle est la conséquence immédiate selon la loi des gaz parfaits ?",
		"answers": ["La température du gaz augmente", "La température du gaz diminue", "La pression du gaz reste constante"],
		"correct_answer": 0,
		"hint": "Selon la loi des gaz parfaits, lorsque le volume d'un gaz est réduit rapidement (compression), la température augmente car la compression fait augmenter l'énergie cinétique des molécules. C'est un effet connu sous le nom de « compression adiabatique ». Rappelez-vous que dans une compression rapide, la température augmente en raison de l'énergie fournie pour effectuer la compression."
	}
]
...
func setup_popup():
	...
	title_label.custom_minimum_size.y = 50  # Increased
	title_label.add_theme_color_override("font_color", Color("#ffc13b"))
	title_label.add_theme_font_size_override("font_size", 32)  # Increased
	...
	close_button.custom_minimum_size = Vector2(250, 50)  # Increased
	close_button.size_flags_horizontal = Control.SIZE_SHRINK_CENTER
	close_button.size_flags_vertical = Control.SIZE_SHRINK_CENTER
	close_button.add_theme_stylebox_override("normal", button_style)
	close_button.add_theme_color_override("font_color", Color.WHITE)
	close_button.add_theme_font_size_override("font_size", 24)  # Increased
	
	hint_label.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	hint_label.vertical_alignment = VERTICAL_ALIGNMENT_CENTER
	hint_label.custom_minimum_size = Vector2(400, 0)  # Increased
	hint_label.add_theme_color_override("font_color", Color.WHITE)
	hint_label.add_theme_font_size_override("font_size", 20)  # Increased
